    ...
    <div class="product__contents">
        ...
        <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form__input">
                ...
                <span class="from__input__require">必須</span>
            ...
            <div class="form__input">
                ...
                <span class="from__input__require">必須</span>
                <input id="price" type="text" name="price" value="{{ old('price') }}" placeholder="値段を入力">
            </div>
            @error('price')
                <div class="error-alert">{{ $message }}</div>
            @enderror
            ...
            <div class="form__input">
                ...
                <span class="from__input__require">必須</span><span class="choice">複数選択可</span>
                <input id="season" type="checkbox" name="seasons[]" value="1"
            ...
            <div class="form__input">
                ...
                <span class="from__input__require">必須</span>
                <textarea id="description" name="description" cols="30" rows="10" placeholder="商品の説明を入力">{{ old('description') }}</textarea>
            </div>
            @error('description')
                <div class="error-alert">{{ $message }}</div>
            @enderror
